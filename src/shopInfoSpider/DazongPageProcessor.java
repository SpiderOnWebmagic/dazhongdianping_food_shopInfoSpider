...
public class DazongPageProcessor implements PageProcessor {
	...
	public void process(Page page) {
		...
		case TYPE_FOOD: {
			...
			// page is not the end 利用首个商店id进行判断
			...
			if (0 != size
				...
				// if it has shops 如果这页铺满了 加入下一頁请求
				if (size >= 15) {
				...
				// find shopinfo 利用shopID构造新的spider进行抓取shopInfo
